...
import { buildMcOptions, weightedShuffle, markCardsSeen } from '@/lib/quiz-utils';
...
export default function QuizPage() {
  ...
  const advanceQuestion = useCallback((answer?: string) => {
    ...
    if (currentQ + 1 < questions.length) {
      ...
      // Mark all cards in this quiz as seen (for repeat avoidance)
      markCardsSeen(updated.map(q => q.card.id));
